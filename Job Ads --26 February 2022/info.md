1. go to /controllers/dbConfig.js to set the configuration for the DB by local path (mongodb://127.0.0.1:27017/ , Community Edition Server) or by cloud provider (Atlas) !
